  ...
  export default {
    ...
    created() {
      if (window.kakao && window.kakao.maps) {
        ...
        script.src = "//dapi.kakao.com/v2/maps/sdk.js?autoload=false?appkey=78b26667d20a38aa946ea1f6a8384730&libraries=services";
    ...
    watch:{
      ...
      point(){
        ...
        const options = {
          center: new kakao.maps.LatLng(36.3551420, 127.298514),
          level: 5,
        };
